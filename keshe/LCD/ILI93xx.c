...
{   
	MY_CALC_mWriteReg(XPAR_MY_CALC_0_S00_AXI_BASEADDR,MY_CALC_S00_AXI_SLV_REG0_OFFSET, reg + data); //write reg
	MY_CALC_mWriteReg(XPAR_MY_CALC_0_S00_AXI_BASEADDR,MY_CALC_S00_AXI_SLV_REG0_OFFSET, nreset + data); //write reg
}
...
{	  
	MY_CALC_mWriteReg(XPAR_MY_CALC_0_S00_AXI_BASEADDR, MY_CALC_S00_AXI_SLV_REG0_OFFSET,is_data + data); //write data
	MY_CALC_mWriteReg(XPAR_MY_CALC_0_S00_AXI_BASEADDR,MY_CALC_S00_AXI_SLV_REG0_OFFSET, nreset + data); //write reg
}
//写寄存器
//LCD_Reg:寄存器地址
...
void LCD_Init(void)
{ 	 
	Xil_Out32(XPAR_MY_CALC_0_S00_AXI_BASEADDR + MY_CALC_S00_AXI_SLV_REG0_OFFSET, nreset);//rst = 0;
	Xil_Out32(XPAR_MY_CALC_0_S00_AXI_BASEADDR +MY_CALC_S00_AXI_SLV_REG0_OFFSET, reset);//rst = 1;
	Xil_Out32(XPAR_MY_CALC_0_S00_AXI_BASEADDR + MY_CALC_S00_AXI_SLV_REG0_OFFSET, nreset);//rst = 0;
 	lcddev.id = 0x5510;
 	LCD_Display_Dir(0);
